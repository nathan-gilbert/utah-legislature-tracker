...
graphql {
  client {
    packageName = "org.mediumcool.graphql.generated"
...
val graphqlIntrospectSchema by tasks.getting(GraphQLIntrospectSchemaTask::class) {
  endpoint.set("https://openstates.org/graphql")
  headers.set(mutableMapOf("X-API-KEY" to openStatesKey))
}

val graphqlGenerateClient by tasks.getting(com.expediagroup.graphql.plugin.gradle.tasks.GraphQLGenerateClientTask::class) {
  packageName.set("org.mediumcool.graphql.generated")
